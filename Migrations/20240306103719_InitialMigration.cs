        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RowVersion = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "text", nullable: false),
                    Slug = table.Column<string>(type: "text", nullable: false),
                    MontlhyBudget = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpectedTransaction", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpectedTransaction_Account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpectedTransaction_Subcategory_SubcategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MoneyTransfer_Account_DestinationAccountId",
                        column: x => x.DestinationAccountId,
                        principalTable: "Account",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoneyTransfer_Account_OriginAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpectedTransaction_AccountId",
                table: "ExpectedTransaction",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpectedTransaction_SubcategoryId",
                table: "ExpectedTransaction",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoneyTransfer_DestinationAccountId",
                table: "MoneyTransfer",
                column: "DestinationAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_MoneyTransfer_GoalId",
                table: "MoneyTransfer",
                column: "GoalId");

            migrationBuilder.CreateIndex(
                name: "IX_MoneyTransfer_OriginAccountId",
                table: "MoneyTransfer",
